---
title: "Lec 10 - ggplot2 ecosystem & designing visualization"
...
```{r pw_plot1, fig.width=10, out.width="70%"}
p1 + p2 + p3 + p4
```

---

```{r pw_plot2, fig.width=10, out.width="70%"}
p1 + p2 + p3 + p4 + plot_layout(nrow=1)
```

---

```{r pw_plot3, fig.width=10, out.width="70%"}
p1 / (p2 + p3 + p4)
```

---

```{r pw_plot4, fig.width=10, out.width="60%"}
p1 + {
  p2 + {
...
```{r pw_plot5, fig.width=10, out.width="70%"}
